...
import { FiSearch, FiMapPin, FiCalendar, FiClock, FiStar, FiChevronRight, FiX } from 'react-icons/fi';
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-gray-600">{selectedEvent.artist}</p>
                  </div>
                  <div className="flex items-center bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm">
                    <FiStar className="mr-1" /> {selectedEvent.rating}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 mb-2">Ticket Options</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg">
                        <div>
                          <h4 className="font-medium">General Admission</h4>
                          <p className="text-sm text-gray-500">Standing room only</p>
                        </div>
                        <div className="text-right">
                          <p className="font-bold">${selectedEvent.price}</p>
                          {selectedEvent.originalPrice && (
                            <p className="text-sm text-gray-500 line-through">${selectedEvent.originalPrice}</p>
                          )}
                        </div>
                      </div>
                      <div className="flex justify-between items-center p-3 border border-gray-200 rounded-lg">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Early entry + perks</p>
                        </div>
                        <div className="text-right">
                          <p className="font-bold">${selectedEvent.price + 100}</p>
                        </div>
                      </div>
                    </div>
                  </div>
