...
const TicketDetailModal = ({ event, onClose, onAddToCart }) => {
  ...
  const createTicket = () => {
    return {
      ...
      cartKey: `${event.id}-${selectedTicketType}`,
    };
  };
          ...
          <div className="p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-bold py-3 px-6 rounded-lg transition duration-300 flex items-center justify-center"
              >
                {isBuyingNow ? (
                  <>
                    <svg
